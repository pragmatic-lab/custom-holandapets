...
class AccountInvoice(models.Model):
	...
	# Calculate withholding tax and (new) total amount 
	@api.one
	@api.depends('invoice_line_ids.price_subtotal', 'tax_line_ids.amount', 'tax_line_ids.amount_rounding', 'currency_id', 'company_id', 'date_invoice', 'type', 'amount_tax', 'wh_taxes')
	def _compute_amount(self):
		...
		for x in self:
			...
			x.amount_without_wh_tax = x.amount_untaxed + x.amount_tax
			x.amount_total = x.amount_without_wh_tax - x.wh_taxes
