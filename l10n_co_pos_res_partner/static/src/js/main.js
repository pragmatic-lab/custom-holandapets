...
modelss.load_fields("res.partner", ['neighborhood']);
modelss.load_fields("res.partner", ['mobile']);
modelss.load_fields("res.partner", ['phone']);
modelss.load_fields("res.partner", ['street2']);
