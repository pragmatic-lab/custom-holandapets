...
class AccountInvoice(models.Model):
	...
	discount_type = fields.Selection([('percentage', 'Porcentaje'), ('amount', 'Monto')], string='Discount Type',
	...
	discount = fields.Monetary(string='Descuento', digits=(16, 2), default=0.0,
							   store=True, compute='compute_discount', track_visibility='always')
	total_before_discount = fields.Monetary(string='Total Antes del Descuento', digits=(16, 2), store=True, compute='compute_total_before_discount')
	
	@api.multi
	def apply_discount(self):

		if self.discount_type and (self.discount_rate > -1) and self.invoice_line_ids:
